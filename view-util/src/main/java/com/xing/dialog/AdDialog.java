...
public class AdDialog {
    ...
    private void initView() {
        initDisplayOpinion();
        double radius = Math.sqrt(PixelUtil.screenhightPx * PixelUtil.screenhightPx + PixelUtil.screenWidthPx * PixelUtil.screenWidthPx);
    ...
    private void initDisplayOpinion() {
        ...
        PixelUtil.density = dm.density;
        PixelUtil.densityDPI = dm.densityDpi;
        PixelUtil.screenWidthPx = dm.widthPixels;
        PixelUtil.screenhightPx = dm.heightPixels;
        PixelUtil.screenWidthDip = PixelUtil.px2dp(dm.widthPixels, mContext);
        PixelUtil.screenHightDip = PixelUtil.px2dp(dm.heightPixels, mContext);
    }
    ...
    public void show() {
        if (mRootView != null) {
            ...
            layoutParams.width = PixelUtil.dp2px(mContentViewWidth, mContext);
            layoutParams.height = PixelUtil.dp2px(mContentViewHeight, mContext);
