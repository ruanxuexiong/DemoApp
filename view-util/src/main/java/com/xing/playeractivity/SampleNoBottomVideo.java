 ...
 */
public class SampleNoBottomVideo extends StandardGSYVideoPlayer {
    ImageView mCoverImage;
    String mPicUrl;
    int mDefaultRes;
    LoadVideoUrlListener mLoadVideoUrlListener;

    public SampleNoBottomVideo(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public SampleNoBottomVideo(Context context) {
        super(context);
    }

    public SampleNoBottomVideo(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public int getLayoutId() {
        return R.layout.video_layout_no_bottom_cover;
    }
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        SampleNoBottomVideo sampleCoverVideo = (SampleNoBottomVideo) gsyBaseVideoPlayer;
